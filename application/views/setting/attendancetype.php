                        ...
                        <form role="form" id="attendancetype_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">                       
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"> <?php echo $this->lang->line('biometric_attendance'); ?></label>
                                            <div class="col-sm-8">
                                                <label class="radio-inline">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-sm-3"> <?php echo $this->lang->line('low_attendance_limit'); ?> <i class="fa fa-question-circle cursor-pointer text-sky-blue" data-toggle="tooltip" data-placement="top" title="<?php echo ('Below it attendance will be mark as low attendance');?>"></i></label>
                                                <div class="col-sm-3">
