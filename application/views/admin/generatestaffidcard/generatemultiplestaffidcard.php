        ...
        ?>
                        ...
                        <div class="signature"><img src="<?php echo base_url('uploads/staff_id_card/signature/' . $id_card[0]->sign_image); ?>" width="150" height="24" style="width: 150px; height: 24px;" /></div>
                            <?php if ($id_card[0]->enable_staff_barcode == 1) {?>
                                <?php if (file_exists("./uploads/staff_id_card/barcodes/" . $staff_value->employee_id . ".png")) {?>
                                <div class="signature"><img src="<?php echo base_url('uploads/staff_id_card/barcodes/' . $staff_value->employee_id . '.png'); ?>" width="180" height="24" style="width: 180px; height: 24px;"/></div>
                           <?php }}?>
