                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="leave_status" value="0" id="leave_status"  ><?php echo $this->lang->line('pending'); ?>
                                        </label>
                                        <label class="radio-inline">
                                            <input value="2" type="radio" id="leave_status" name="leave_status" ><?php echo $this->lang->line('disapprove'); ?>                                               
                                        </label> 
                                        <label class="radio-inline">
                                            <input value="1" type="radio" id="leave_status" name="leave_status" ><?php echo $this->lang->line('approve'); ?>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
