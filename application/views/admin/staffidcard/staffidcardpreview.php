...
<table cellpadding="0" cellspacing="0" width="100%" style="background: <?php echo $idcard->header_color; ?>;">
    <tr>
        <td valign="top">
            <img src="<?php echo $this->media_storage->getImageURL('uploads/staff_id_card/background/'.$idcard->background); ?>" class="tcmybg" style="opacity: .1"/></td>
    </tr>
    <tr>
...
if ($idcard->enable_staff_dob == 1) {
    ...
    ?>
                        ...
                        <?php if ($idcard->enable_staff_barcode == 1) {?>
                        <?php if (file_exists("./uploads/staff_id_card/barcodes/default.png")) {?>
                            <div class="signature"><img src="<?php echo $this->media_storage->getImageURL('uploads/staff_id_card/barcodes/default.png'); ?>" width="80" height="24"/></div>
                        <?php }}?>
            ...
            <tr>
                <td valign="top" width="32%" style="padding: 3px;">
                    <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #efefef;">
                        <tr>
                            <td valign="top">
                                <img src="<?php echo $this->media_storage->getImageURL('uploads/staff_id_card/background/') ?><?php echo $idcard->background; ?>" class="tcmybg" style="opacity: .1"/></td>
                        </tr>
                        <tr>
                            <td valign="top">
...
if ($idcard->enable_staff_dob == 1) {
    ...
    ?>
                        ...
                        <tr>
                            <?php if ($idcard->enable_staff_barcode == 1) {?>
                            <?php if (file_exists("./uploads/staff_id_card/barcodes/default.png")) {?>
                              <td valign="top" align="right" class="principal"> <img src="<?php echo $this->media_storage->getImageURL('uploads/staff_id_card/barcodes/default.png'); ?>" width="80" height="24"/></td>
                            <?php }}?>
                        </tr>
                    </table>
                </td>
