            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <ul class="toplist">
                            <li>
                                <a href="mailto:<?php echo $school_setting->email; ?>"><i class="fa fa-envelope-o"></i>
                                <?php echo $school_setting->email; ?></a></li>
                        ...
                        <ul class="topicon">
                         ...
                         <li >
                            ...
                            if (!$this->session->userdata('student')) {  ?>
                                <a class="px-3" onclick="openmodal()"><?php echo $this->lang->line('login'); ?></a>
                            <?php } else {?>
                                <a class="px-3" href="<?php echo base_url(); ?>course/logout"><?php echo $this->lang->line('logout'); ?></a>
                            <?php } }else{ if ($setting_data[0]['student_panel_login']) { ?>
                                <a class=""  href="<?php echo base_url(); ?>site/userlogin">
                                <span class="btn btn-danger p-2" style="margin-top: -2px!important;"><?php echo $this->lang->line('login'); ?></span>
                            </a>
                            <?php } } ?>                  
                            </li>
