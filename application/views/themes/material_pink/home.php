...
<body>
    ...
    <section class="title-section">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12" style="padding: 0px; margin: 0px;">
                    <div class="marquee-title" style="padding:14px; ">
            ...
            <div class="row">
                <div class="col-md-9" style="padding: 0px; margin: 0px;">
                    ...
                    <div class="row">
                        <div class="col-4 col-sm-4">
                            <img src="<?php echo base_url(); ?>uploads/images/history.jpg"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="<?php echo base_url(); ?>uploads/images/21.00.40.jpg" name="" alt=""
                                class="img-responsive img-fluid " style="">
                        </div>
                        <div class="col-md-8">
                            <p>
                                "শিক্ষা হলো আলো, জ্ঞানের উজ্জ্বল আলো, যা আমাদের জীবনে প্রজন্মের উন্নতি এবং সমাজের
                                সুধারণে প্রথম পথ প্রদর্শন করে। আমরা শিক্ষার মাধ্যমে নতুন দিনের প্রথম আলোকিত পথে অগ্রসর
                                হতে পারি, এবং এই উজ্জ্বল পথে আমাদের শিক্ষার্থীদের আগামী দিনের নেতৃত্বক্ষম নাগরিক হিসেবে
                                সমর্থ করতে পারি।</p>

                            <p> আমরা শিক্ষার মাধ্যমে জ্ঞানের আলো জাগিয়ে, সমস্যা সমাধানে উপস্থিত হতে সমর্থ করি, এবং
                                মানবিক মূল্যগুলির প্রতি সদয় আগ্রহ জাগিয়ে দেই। আমরা যেসব ছাত্র-ছাত্রীদের মাধ্যমে নতুন
                                আলো বিশ্বের আকাশে এনে প্রতিষ্ঠা দেওয়ার দিকে চলতে চাই, তাদের সাথে সাথে এই পথে এগিয়ে
                                যাওয়া নিশ্চিত করে নেই। আমরা একটি সাধারণ শিক্ষা প্রতিষ্ঠান থেকে একটি অসীম সম্পন্ন জীবনের
                                নির্মাতা তৈরি করতে সাহায্য করি।</p>

                            <p> এই স্কুল একটি শিক্ষার মন্দির, একটি জ্ঞানের উজ্জ্বল অগ্নিকুণ্ড, এবং আমাদের ভবিষ্যতের শুভ
                                আলোকের উত্তরণ ক্ষেত্র। আমরা গর্বিত এবং নির্ভরশীল, এবং এই সফল পথে এগিয়ে যাওয়ার সাথে
                                সাথে আমরা এই সমৃদ্ধ সমাজে একজন ভাল নাগরিক হিসেবে আমাদের দেশের উন্নতির দিকে যাচ্ছি।"</p>
                            ...
                            <div class="card mb-4">
                                <div class="clearfix clearfix-card">
                                    ...
                                    <div class="float-start">
                                        <img src="<?php echo base_url(); ?>uploads/images/menu01.jpg-copy-150x150.png"
                                            name="" alt="" class="align-self-center mr-3">
                                    </div>
                                    <div class="float-end">
                                        <ul>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">ছাত্রছাত্রীর
                                                    আসন সংখ্যা</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">ভর্তি তথ্য</a>
                                            </li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">নোটিশ</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">রুটিন</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">কৃতি
                                                    শিক্ষার্থী</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4">
                                <div class="clearfix clearfix-card">
                                    ...
                                    <div class="float-start">
                                        <img src="<?php echo base_url(); ?>uploads/images/te.png" name="" alt=""
                                            class="align-self-center mr-3">
                                    </div>
                                    <div class="float-end">
                                        <ul>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a
                                                    href="#">শিক্ষকবৃন্দ</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">শূণ্যপদের
                                                    তালিকা</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">প্রাক্তন
                                                    প্রধান শিক্ষক</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">কর্মকর্তা
                                                    কর্মচারী</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">পরিচালনা
                                                    পরিষদ</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4">
                                <div class="clearfix clearfix-card">
                                    ...
                                    <div class="float-start">
                                        <img src="<?php echo base_url(); ?>uploads/images/do-150x150.png" name="" alt=""
                                            class="align-self-center mr-3">
                                    </div>
                                    <div class="float-end">
                                        <ul>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">১ম সাময়িকি
                                                    পরীক্ষার রুটিন ডাউনলোড</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">এসএসসি
                                                    পরীক্ষার রুটিন ডাউনলোড</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">ছুটির নোটিশ
                                                    ডাউনলোড</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">ভর্তি ফরম
                                                    ডাউনলোড</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">পরীক্ষার রুটিন
                                                    ডাউনলোড</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4">
                                <div class="clearfix clearfix-card">
                                    ...
                                    <div class="float-start">
                                        <img src="<?php echo base_url(); ?>uploads/images/ca-150x150.png" name="" alt=""
                                            class="align-self-center mr-3">
                                    </div>
                                    <div class="float-end">
                                        <ul>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">নোটিশ</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">কক্ষ
                                                    সংখ্যা</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">ছুটির
                                                    তালিকা</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">মাল্টিমিডিয়া
                                                    ক্লাসরুম</a></li>
                                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="#">ছাত্রছাত্রীর
                                                    আসন সংখ্যা</a></li>
                                        </ul>
                ...
                <div class="col-md-3">
                    <div class="list-button">
                        <ul>
                            <li><a href="#" class="button"><i class="fa fa-arrow-circle-o-right"
                                        aria-hidden="true"></i>ভর্তি তথ্য</a></li>
                            <li><a href="#" class="button"><i class="fa fa-arrow-circle-o-right"
                                        aria-hidden="true"></i>ভর্তি ফরম</a></li>
                            <li><a href="#" class="button"><i class="fa fa-arrow-circle-o-right"
                                        aria-hidden="true"></i>ফটোগ্যালারী</a></li>
                            <li><a href="#" class="button"><i class="fa fa-arrow-circle-o-right"
                                        aria-hidden="true"></i>ভিডিও গ্যালারী</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="official-link">
                        <h3>অফিসিয়াল লিংক</h3>
                        <ul>
                            <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>শিক্ষা
                                    মন্ত্রণালয়</a></li>
                            <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>ব্যানবেইজ</a>
                            </li>
                            <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>সেকায়েপ</a>
                            </li>
                            <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>এসএসসি/এইচএসসি
                                    ফলাফল</a></li>
                            <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>সেকায়েপ</a>
                            </li>
                        </ul>
                    ...
                    <div class="official-link">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>এসএসসি/এইচএসসি
                                    ফলাফল</a></li>
                            <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>মাধ্যমিক ও উচ্চ
                                    শিক্ষা অধিদপ্তর</a></li>
    ...
    <script src="<?php echo base_url(); ?>backend/font/slick/slick.min.js" integrity=""
        crossorigin="anonymous"></script>
