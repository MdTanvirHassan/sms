...
{ 
    ...
    public function cbseexam()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $subject_assessments = $this->cbseexam_assessment_model->getWithAssessmentTypeByAssessmentID($exam->cbse_exam_assessment_id);    
            $cbse_exam_result = $this->cbseexam_exam_model->getStudentExamResultByExamIdAndRollNo($exam_id,$roll_no);
