...
class Staff_model extends MY_Model
{
    ...
    public function get_principle($id = null, $is_active = null)
    {

        $this->db->select("staff.*,staff_designation.designation,department.department_name as department, roles.id as role_id, roles.name as role");
        $this->db->from('staff');
        $this->db->join('staff_designation', 'staff_designation.id = staff.designation', 'left')
        ->where('staff_designation.id', 2);
    ...
    public function get_teacher($id = null, $is_active = null)
    {
        ...
        $this->db->join('staff_designation', "staff_designation.id = staff.designation", "left");
        $this->db->join('staff_roles', "staff_roles.staff_id = staff.id", "left");
        $this->db->join('roles', "roles.id = staff_roles.role_id", "left")->where('roles.id','2');
        $this->db->join('department', "department.id = staff.department", "left");
    ...
    public function get_managing_team($id = null, $is_active = null)
    {
    ...
    public function get_staff($id = null, $is_active = null)
    {
